# PermissionRequest hook for Dorothy (Windows)
...
try {
  $body = @{ agent_id = $AGENT_ID; session_id = $SESSION_ID; status = "waiting"; waiting_reason = "permission" } | ConvertTo-Json -Compress
